<template>
  <div>
    <l-map ref="myMap" class="mhy-map" style="width: 100vw; height: 100vh" :crs="crs" :zoom="zoom" :max-bounds="maxBounds" :max-zoom="maxZoom" :min-zoom="minZoom" :center="center" :options="{ zoomControl: false, noWrap: true, continuousWorld: true }" @click="selectPoint(-1)" @ready="doSomethingOnReady()">
